...
int32_t ST25DVxxKC_ReadReg(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
			   const uint16_t Reg, uint8_t *const Data, const uint16_t len);
int32_t ST25DVxxKC_WriteReg(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
			    const uint16_t Reg, const uint8_t *const Data, const uint16_t len);
/* Public functions ---------------------------------------------------------*/
/**
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_GetICREF(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
			    uint8_t *const value)
{
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_GetMEM_SIZE_MSB(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
				   uint8_t *const value)
{
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_GetBLK_SIZE(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
			       uint8_t *const value)
{
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_GetMEM_SIZE_LSB(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
				   uint8_t *const value)
{
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_GetRF_MNGT_RFDIS(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
				    uint8_t *const value)
{
	int32_t ret;
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_SetRF_MNGT_RFSLEEP(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
				      const uint8_t *const value)
{
	...
	if (ret == 0) {
		reg_value = ((*value << (ST25DVXXKC_RF_MNGT_RFSLEEP_SHIFT)) &
			     (ST25DVXXKC_RF_MNGT_RFSLEEP_MASK)) |
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_GetRF_MNGT_DYN_RFDIS(const struct device *dev, const ST25DVxxKC_Ctx_t *const ctx,
					uint8_t *const value)
{
	int32_t ret;
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_GetRF_MNGT_DYN_RFSLEEP(const struct device *dev,
					  const ST25DVxxKC_Ctx_t *const ctx, uint8_t *const value)
{
	int32_t ret;
 ...
 * @return 0 in case of success, an error code otherwise
 */
int32_t ST25DVxxKC_SetRF_MNGT_DYN_RFSLEEP(const struct device *dev,
					  const ST25DVxxKC_Ctx_t *const ctx,
					  const uint8_t *const value)
{
	uint8_t reg_value;
	int32_t ret;
	...
	if (ret == 0) {
		reg_value = ((*value << (ST25DVXXKC_RF_MNGT_DYN_RFSLEEP_SHIFT)) &
			     (ST25DVXXKC_RF_MNGT_DYN_RFSLEEP_MASK)) |
