 ...
 *(https://github.com/STMicroelectronics/x-cube-nfc7/tree/main/Drivers/BSP/Components/st25dvxxkc) at
 *commit 107e25d1c22d9e855c1208bd2a34dc1811582c2d.
 *
...
#define MCU_FW_VERSION                                                                             \
	STRINGIZE(MCU_FW_VERSION_MAJOR)                                                            \
	"." STRINGIZE(MCU_FW_VERSION_MINOR) "." STRINGIZE(MCU_FW_VERSION_REVISION)
