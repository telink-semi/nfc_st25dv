 ...
 */
typedef int32_t (*ST25DVxxKC_WriteReg_Func)(const struct device *, const void *const,
					    const uint16_t, const uint8_t *const, const uint16_t);

/**
 * @brief  ST25DVxxKC Read register function typedef definition.
 */
typedef int32_t (*ST25DVxxKC_ReadReg_Func)(const struct device *, const void *const, const uint16_t,
